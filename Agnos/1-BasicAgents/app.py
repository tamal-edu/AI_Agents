...
# # Import Agno components and our required tools/models
...
# # Import Hugging Face libraries for our custom embedder
...
# # (If you also need an OpenAI key, uncomment the following lines)
...
#         # Mean pooling over tokens to get a single embedding vector
...
# # Web Agent: Uses DuckDuckGo to search the web and always includes sources.
# web_agent = Agent(
#     name="Web Agent",
...
# # Finance Agent: Retrieves financial data and displays it in tables.
# finance_agent = Agent(
#     name="Finance Agent",
...
# # Chef Agent: Leverages a PDF knowledge base (e.g. Thai recipes) with a custom embedder.
...
#         embedder=HuggingFaceEmbedder()  # Use our custom Hugging Face embedder
#     ),
# )
...
# chef_agent = Agent(
#     name="Chef Agent",
#     description="Thai Cuisine Expert",
#     model=Groq(id="qwen-2.5-32b"),
#     instructions=[
...
# # Team Agent: Combines the Web and Finance agents into a multiagent team.
# team_agent = Agent(
...
# st.markdown("This is a simple agentic generative AI application built with Groq, Agno, Streamlit, and powerful open source LLMs.")

# # Select which agent to use
# agent_option = st.selectbox("Select Agent", options=["Web Agent", "Finance Agent", "Chef Agent", "Team Agent"])
...
#     # Depending on the selected agent, call its print_response method.
#     if agent_option == "Web Agent":
#         response = web_agent.print_response(user_query, stream=False)
#     elif agent_option == "Finance Agent":
#         response = finance_agent.print_response(user_query, stream=False)
#     elif agent_option == "Chef Agent":
#         response = chef_agent.print_response(user_query, stream=False)
#     elif agent_option == "Team Agent":
#         response = team_agent.print_response(user_query, stream=False)
#     else:
...
def main():
    ...
    st.markdown(
        "This app is an agentic generative AI system built with **Groq**, **Agno**, and **Streamlit**. "
        "It includes conversation memory, duplicate query lookup, and a Telemetry Option inspired by Phidata's (Now Agnos) ideas. "
